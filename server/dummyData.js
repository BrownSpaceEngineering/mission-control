const data = {
  twitterTimeline: [{
    ...
    user: {
      ...
      description: 'The Real Twitter API. I tweet about API changes, service issues' +
      " and happily answer questions about Twitter and our API. Don't get an answer? It's on my website.",
      ...
      prodile_sidebar_border_color: 'C0DEED',
    ...
    retweeted_status: {
      ...
      user: {
        ...
        profile_link_color: '0084B4',
        prodile_sidebar_border_color: 'FFFFFF',
        profile_sidebar_fill_color: 'DDEEF6',
        profile_text_color: '333333',
    ...
    retweeted_status: {
      ...
      user: {
        ...
        screen_name: 'TwitterMktg',
        location: 'Twitter HQ ',
        description: 'Twitter’s place for marketers, agencies, and creative thinkers' +
        ' ⭐ Bringing you insights, news, updates, and inspiration. Visit @TwitterAdsHelp for Ads support.',
